      ...
      <main className='w-full h-[95%] overflow-y-scroll overflow-x-hidden  px-2'>
        ...
        {global && globMsg && loading === false ? globMsg.map((el, k) => {
          ...
          if (el.from === from) {
            return (
              //right div
              <div key={k} id='messageCommingFromBackendFrom' className="w-full flex justify-end  items-end">
                <div
